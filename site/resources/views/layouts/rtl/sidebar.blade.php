<aside class="page-sidebar">
   <div class="sidebar-user text-center">
      ...
      <h6 class="mt-3 f-12">{{ session('username', 'کاربر') }}</h6>
      @if(session('user_role') == 'admin')
         <span class="badge badge-danger">ادمین</span>
      @elseif(session('user_role') == 'marketer')
   ...
   <ul class="sidebar-menu">
      ...
      <li>
         <form action="{{ route('logout') }}" method="POST" style="margin: 0;">
            @csrf
            <button type="submit" class="sidebar-header" style="background: none; border: none; width: 100%; text-align: right; cursor: pointer; color: #dc3545;">
               <i data-feather="log-out"></i><span>خروج</span>
            </button>
         </form>
      </li>
